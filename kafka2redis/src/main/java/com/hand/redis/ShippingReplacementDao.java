...
@Repository
public class ShippingReplacementDao extends BaseDao {
	
	public ShippingReplacementDao(){
		super();
		//clazz对应key名的Staff
		this.clazz = "Replace:shippingReplacement"; 
		//hashTag对应key名中的{ staff }
		this.hashTag = "replace";
		//设置refundId为hash_key
		this.idDescriptor = createFieldDescriptor("replaceId",FieldType.TYPE_EQUAL);
