...
//        redisTemplate.convertAndSend(channel, "add|" + pattern + "|" + json);
//        pubClient.pub(channel, "add|" + pattern + "|" + json);
        //遍历对象需要进行搜索的字段
...
//            pubClient.pub(channel, "del|" + idHashKey + "|" + id + "|" + json);
        } else {
...
//        pubClient.pub(channel, "up|" + pattern + "|" + json);
        //当EQUAL字段的SCORE更改时
